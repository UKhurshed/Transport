...
public class Airbus extends Airplane implements TransportInfo {

    private int countSeat;
    private double distanceFlight;

    public Airbus(String model, String color, int maxSpeed, int countSeat, double distanceFlight){
    ...
    public void getDistanceFlight(double distanceFlight) {
        this.distanceFlight = distanceFlight;
    }
}
