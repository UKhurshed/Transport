...
public class BMW extends Car implements TransportInfo {

    private String typeOil;
    private double literFuel;

    public BMW(String model, String color, int maxSpeed, int horsePower, int distance, String typeOil, double literFuel){
